...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative overflow-hidden pt-16 pb-6 md:pt-32 md:pb-12">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center order-2 md:order-1 mt-4 md:mt-0 mb-4 md:mb-0 md:pr-8">
            {/* Location badge */}
            <div className="inline-flex items-center rounded-full bg-secondary/80 backdrop-blur-sm px-3 py-1 md:px-4 md:py-2 text-xs md:text-sm font-medium text-secondary-foreground mb-3 md:mb-6 w-fit opacity-0 animate-fade-in shadow-sm border border-primary/10">
              <MapPin className="h-4 w-4 text-primary mr-2" />
              Karve Nagar, Pune
            </div>

            {/* Main heading with enhanced styling */}
            <h1 className="font-display mb-3 md:mb-6 text-3xl md:text-5xl lg:text-7xl font-extrabold tracking-tight text-foreground opacity-0 animate-fade-in animate-delay-100">
            ...
            <div className="mb-4 md:mb-8 opacity-0 animate-fade-in animate-delay-200">
              <h2 className="text-lg md:text-2xl font-bold text-primary mb-2 md:mb-3 flex items-center">
                Transform Your Fitness Journey
              </h2>
              <p className="text-foreground/90 font-medium text-sm md:text-lg leading-relaxed">
          ...
          <div ref={imageRef} className="order-1 md:order-2 opacity-0 animate-fade-in animate-delay-200">
            <div className="relative mx-auto max-w-md md:max-w-none">
              ...
              <div className="glass-panel rounded-2xl overflow-hidden shadow-xl border-2 border-primary/20 relative h-[220px] md:h-[450px] transform transition-all duration-500 hover:shadow-primary/20 hover:scale-[1.01]">
        ...
        <div className="mt-6 md:mt-16 mb-4 opacity-0 animate-fade-in animate-delay-400">
          <div className="glass-panel rounded-2xl p-3 md:p-8 backdrop-blur-md border border-primary/20 shadow-lg">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 stagger-children">
              <div className="flex flex-col items-center p-2 md:p-4 text-center relative group transition-all duration-300 hover:bg-primary/5 rounded-xl">
                ...
                <div className="text-2xl md:text-3xl font-extrabold text-primary mb-0 md:mb-1 drop-shadow-sm">5+</div>
                <div className="text-xs md:text-sm font-medium text-foreground/80">Years Experience</div>
              </div>

              <div className="flex flex-col items-center p-2 md:p-4 text-center relative group transition-all duration-300 hover:bg-primary/5 rounded-xl">
                <div className="absolute inset-x-0 bottom-0 h-1 bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center rounded-full"></div>
                <Users className="h-6 w-6 md:h-8 md:w-8 text-primary mb-1 md:mb-3 group-hover:scale-110 transition-transform" />
                <div className="text-2xl md:text-3xl font-extrabold text-primary mb-0 md:mb-1 drop-shadow-sm">500+</div>
                <div className="text-xs md:text-sm font-medium text-foreground/80">Happy Clients</div>
              </div>
              ...
              <div className="flex flex-col items-center p-2 md:p-4 text-center relative group transition-all duration-300 hover:bg-primary/5 rounded-xl">
                ...
                <div className="text-2xl md:text-3xl font-extrabold text-primary mb-0 md:mb-1 drop-shadow-sm">6</div>
                <div className="text-xs md:text-sm font-medium text-foreground/80">Training Programs</div>
              </div>

              <div className="flex flex-col items-center p-2 md:p-4 text-center relative group transition-all duration-300 hover:bg-primary/5 rounded-xl">
                <div className="absolute inset-x-0 bottom-0 h-1 bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center rounded-full"></div>
                <Star className="h-6 w-6 md:h-8 md:w-8 text-primary mb-1 md:mb-3 group-hover:scale-110 transition-transform" />
                <div className="text-2xl md:text-3xl font-extrabold text-primary mb-0 md:mb-1 drop-shadow-sm">4.9</div>
                <div className="text-xs md:text-sm font-medium text-foreground/80">Client Rating</div>
              </div>
            </div>
          </div>
        </div>
